...
ALTER TABLE products ADD COLUMN id_brend INTEGER NOT NULL;
/* 2025-02-01 22:33:31 [36 ms] */ 
ALTER TABLE products MODIFY COLUMN name VARCHAR(150);
/* 2025-02-01 22:35:03 [61 ms] */ 
ALTER TABLE products ADD FOREIGN KEY (id_brend) REFERENCES brends(id);
...
INSERT INTO brends (name,site,phone) VALUES
 ('Apple', 'apple.com', '0800-761-0867'),
 ('Dell', 'dell.com.br', '0800-762-0867'),
 ('Shure','shure.com.br', '0800-753-3355');
/* 2025-02-01 22:48:33 [5 ms] */ 
INSERT INTO products VALUES 
  (1, 'Iphone 16 Pro Apple (256G) - Black Steal', 9800.99, 100, 1),
  (2, 'Notebook Dell (1T) - Black Steal', 10000.1, 1, 2);
/* 2025-02-01 22:50:48 [5 ms] */ 
INSERT INTO products (name, price, stoke, id_brend) VALUES 
  ('Iphone 16 Pro Apple (256G) - Black Steal', 9800.99, 100, 1),
  ('Notebook Dell (1T) - Black Steal', 10000.1, 1, 2);
/* 2025-02-01 22:51:53 [1 ms] */ 
SELECT * FROM brends LIMIT 100;
/* 2025-02-01 22:52:00 [2 ms] */ 
SELECT id FROM brends LIMIT 100;
/* 2025-02-01 22:52:10 [1 ms] */ 
SELECT id,name FROM brends LIMIT 100;
/* 2025-02-01 22:52:37 [1 ms] */ 
SELECT id, name FROM brends WHERE id = 1 LIMIT 100;
/* 2025-02-01 22:52:42 [1 ms] */ 
SELECT id, name FROM brends WHERE id = 2 LIMIT 100;
...
SELECT name, stoke FROM products WHERE id_brend = 1 LIMIT 100;
/* 2025-02-01 22:56:33 [4 ms] */ 
INSERT INTO apple_products
SELECT name, stoke FROM products WHERE id_brend = 1;
/* 2025-02-01 22:56:52 [2 ms] */ 
SELECT * FROM apple_products LIMIT 100;
...
UPDATE products SET name = "Microfone SM7B Black" WHERE name = 'Notebook Dell (1T) - Black Steal-2';
...
UPDATE products 
SET name = "Microfone SM7B Black" 
WHERE name = 'Notebook Dell (1T) - Black Steal-1';
...
UPDATE products 
SET name = "Microfone SM7B Red" 
WHERE id = 4;
/* 2025-02-01 23:05:15 [1 ms] */ 
SELECT * FROM products LIMIT 100;
/* 2025-02-01 23:06:51 [5 ms] */ 
UPDATE products SET stoke = stoke + 10 WHERE id_brend = 2;
...
SELECT * FROM products WHERE stoke < 80 AND price < 3000 LIMIT 100;
/* 2025-02-04 21:34:55 [1 ms] */ 
SELECT * FROM products WHERE name LIKE 'IPhone%' LIMIT 100;
/* 2025-02-04 21:35:18 [2 ms] */ 
SELECT * FROM products WHERE name LIKE 'Apple%' LIMIT 100;
/* 2025-02-04 21:35:22 [1 ms] */ 
SELECT * FROM products WHERE name LIKE '%Apple%' LIMIT 100;
/* 2025-02-04 21:37:12 [1 ms] */ 
SELECT * FROM products ORDER BY stoke ASC LIMIT 100;
/* 2025-02-04 21:37:28 [1 ms] */ 
SELECT * FROM products ORDER BY stoke DESC LIMIT 100;
...
INSERT INTO order_items (order_id, product_id, quantity, unity_price) VALUES
(3, 1, 1, 3500.00),
(3, 2, 1, 2000.00),
(4, 2, 1, 2000.00);
...
SELECT name, price FROM products 
   WHERE id_brend 
   IN (SELECT id FROM brends WHERE name = 'Apple');
...
SELECT city, COUNT(*) as client_amount FROM clients GROUP BY city; 


SELECT DATE_FORMAT(order_date, '%Y-%m') as month, AVG(total) as total_avg 
FROM orders GROUP BY month;

SELECT sum(total)/COUNT(*) as avg FROM orders;

SELECT MAX(total) AS biggest_order, MIN(total) as smallest_order from orders; 
...
FROM
   products
WHERE 
   stoke < (SELECT AVG(stoke) from products);
...
SELECT 
      ...
      COUNT(*) amount_sells 
FROM
   clients AS c INNER JOIN orders AS o ON c.id = o.id_client
WHERE
   c.city IN ('Sao Jose dos Campos', 'Rio de janeiro')
GROUP BY
   c.city
HAVING raw_total < 7000;